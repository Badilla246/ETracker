<template>
    <div class="cons flex justify-center items-center min-h-screen">
      <div class="cons1 container mx-auto p-8 bg-blue rounded-lg shadow-lg border border-black-300">
        <h1 class="text-5xl text-center text-gray-800 mb-10">Expense Track Expenses</h1>
        <div class="flex">
                <div class="flex-1 mr-8 max-w-lg max-w-lg transition-all duration-500 ease-in-out transform hover:scale-105">
                  <div class="fill">
                    ...
                    <select v-model="newExpense.category" class="input-field">
                        ...
                        <option value="transportation">Tools</option>

                    </select>
                    <input type="text" v-model="amountInput" placeholder="Amount" class="input-field">
                    <button @click="addOrUpdateExpense" class="btn-primary">Add Expense
                    </button>
          ...
          <div class="flex-1 relative"> 
            ...
            <center><div class="total-expenses border-t border-gray-300 text-center">Total Expenses: {{ totalExpenses }}</div></center>
          </div>
        </div>
      </div>
    </div>
  ...
  <style scoped>
    ...
    .cons{
      background-color: rgb(139, 206, 206);
    }
    .cons1{
    ...
    .fill{
      ...
      font-size: 15px;
      font-weight: bold;
      background-color: rgb(193, 127, 254);
    }
    .input-field:hover {
        box-shadow: 0 0 10px rgba(0,0,1,1);
    }
